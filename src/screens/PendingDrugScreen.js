...
class PendingDrugScreen extends Component {
  ...
  componentWillMount=()=>{
    url='http://192.168.43.252:3000/api/prescriptions/notacquired';
    ...
    return (
      <Container>
        <Header>
          ...
          <Body style={{flex:1}}>
            <Text style={{textAlign:'center', fontWeight:'bold'}}>UnAcquired Prescriptions</Text>
          </Body>
          <Right style={{flex:1}}>
...
export default connect(mapStateToProps,mapDispatchToProps)(PendingDrugScreen)
